...
impl Server {
    ...
    pub async fn apply_pending_update(&self, stream: &mut TcpStream, stream_id: &String) {
    ...
    pub async fn add_slave(&self, stream_id: &String) {
                                ...
                                (
                                    ...
                                    match commande.as_str() {
                                        ...
                                        "PSYNC" => {
                                            ...
                                            server.add_slave(&stream_id).await
                                        }
                                        _ => {
